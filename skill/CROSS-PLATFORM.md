...
> **v5.8.0 已验证跨平台运行**：核心框架在 Windows、macOS、Linux 上均可使用。
...
```bash
# 1. 解压包
tar xzf deliverhq-v5.8.0.tar.gz   # 或 7z x deliverhq-v5.8.0.7z
cd DeliverHQ
...
**总结**：DeliverHQ v5.8.0 框架本身已跨平台适配。用户只需确保 Python + Git 在 PATH，并让自定义验证命令遵循跨平台规范。
