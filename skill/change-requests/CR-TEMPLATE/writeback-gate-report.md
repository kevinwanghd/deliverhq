...
- [x] / [ ] 工作目录已移动到 `_archived/CR-{{ID}}-{{date}}/`
- [x] / [ ] 归档目录设为只读
...
### 文档归档
检查的文档：
- `DeliverHQ/docs/architecture.md`（最后更新：{{date}}）
- `DeliverHQ/docs/interfaces.md`（最后更新：{{date}}）
- `DeliverHQ/docs/data-model.md`（最后更新：{{date}}）
- `DeliverHQ/docs/rules.md`（最后更新：{{date}}）
- `DeliverHQ/docs/decisions.md`（最后更新：{{date}}）
- `DeliverHQ/docs/mistake-book.md`（最后更新：{{date}}）
