...
2. 替换所有模板变量（`CR-006`、`Bootstrap、Lane 成本提示与 Context 证据强化` 等）
3. 填充当前日期和提出人
...
# 手动替换变量（容易遗漏）
find . -type f -exec sed -i 's/CR-006/CR-001/g' {} \;
find . -type f -exec sed -i 's/Bootstrap、Lane 成本提示与 Context 证据强化/实现用户登录功能/g' {} \;
find . -type f -exec sed -i 's/2026-07-12/2026-06-11/g' {} \;
```
...
|---|---|---|
| `CR-006` | CR 编号 | CR-001 |
| `Bootstrap、Lane 成本提示与 Context 证据强化` | CR 名称 | 实现用户登录功能 |
| `2026-07-12` | 日期 | 2026-06-11 |
| `Codex` | 提出人 | 产品经理 |
